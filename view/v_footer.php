      ...
      <div id="footer">
        <div id="highscores-trigger" onclick="loadHighscores()">
          <div id="highscores-trigger-text"><?=$text['highscores']?></div>
        </div>
        <div id="game-pause" data-pause="" data-btntext='<?=$json?>' data-status="">
          <div id="game-pause-text">
            <?=$text['game_pause']?>
          </div>
        </div>
