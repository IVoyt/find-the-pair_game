<div id="select-game" style="opacity: 0; transition: opacity 0.7s ease-out 0s;">
  <input id="enter-player-name" name="player_name" type="text" placeholder="<?=$text['enter_player_name']?>" value="<?=(isset($_SESSION['player_name'])) ? $_SESSION['player_name'] : ''?>" required />
  <div id="select-field">
